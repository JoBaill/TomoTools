...
function Newlbfgs_Jo(nlp :: AbstractNLPModel,Z,gₖₚ,gprec,∇f,f;
...
#println("x du lbfgs = $x")
        ...
        #   end#if linesearch in interfaced_algorithms
          ...
          assez_ortho = ((1-η₁) >= ((norm(∇ft).^2)/(norm(gₖₚ).^2)) )
    ...
    return (x, x_moins, t, d, ∇ft, gₖₚ, gprec, Hₖ, tired, optimal, assez_ortho)
