...
function Tomo_tv_fista_A_b2(nlp :: AbstractNLPModel,
                            pD,
                            pR;
...
#vf,vg,vfR,vfD,vgR,vgD = eval_costpDpR(z_iter,pD,pR;kwargs...)#TODO
vf,vg=objgrad(nlp,z_iter)
print_with_color(:cyan,string(vf))
    println("")
    if mon == 0
      x_iter = z_iter;
    else
